...
namespace Task.Mohamed_eid
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBankType, BankTypeRepository>();
            services.AddScoped<IDamageTypes, DamageTypesRepository>();
            services.AddScoped<IRegions, RegionRepository>();
